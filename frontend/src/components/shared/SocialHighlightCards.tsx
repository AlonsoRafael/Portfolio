...
const socials: SocialItem[] = [
	{
		label: "Rafael Alonso no LinkedIn",
		href: "https://www.linkedin.com/in/rafael-alonso-5b5099207/",
		icon: "linkedin",
	},
	{
		label: "Rafael Alonso no GitHub",
		href: "https://github.com/AlonsoRafael",
		icon: "github",
	},
]

function SocialIcon({ name = "linkedin" }: { name: string }) {
	if (name === "linkedin") {
		return (
			<svg viewBox="0 0 24 24" aria-hidden="true">
				<path
					fill="currentColor"
					d="M5.1 3.5a2.1 2.1 0 1 0 0 4.2 2.1 2.1 0 0 0 0-4.2ZM3.3 8.9h3.6V20H3.3V8.9Zm5.8 0h3.4v1.5h.1c.5-.9 1.6-1.9 3.5-1.9 3.7 0 4.4 2.4 4.4 5.6V20h-3.6v-5.1c0-1.2 0-2.8-1.7-2.8s-2 1.3-2 2.7V20H9.1V8.9Z"
				/>
			</svg>
		)
	}
		...
		<nav className="social-highlight-cards" aria-label="Social links">
			{socials.map((social) => (
				...
				>
					...
					<span className="social-highlight-card__icon">
